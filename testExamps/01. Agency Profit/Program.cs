...
namespace _01._Agency_Profit
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double numTiketAdult = double.Parse(Console.ReadLine());
            double numTiketChild = double.Parse(Console.ReadLine());
            double priceTiketAdult = double.Parse(Console.ReadLine());
            double taxServise = double.Parse(Console.ReadLine());
            double priceTiketChild = priceTiketAdult * 0.3 + taxServise;
            double priceAdult = priceTiketAdult + taxServise;
            double ollSum = numTiketAdult * priceAdult + numTiketChild * priceTiketChild;
            double profit = ollSum * 0.2;
